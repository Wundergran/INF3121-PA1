...
public class Minesweeper {
	...
	private static boolean gameCountinue() {
		...
		while (true) {
            ...
            if(!commandInput(input, result)){
                return false;
            }else if(performMove(input, result)){
                return true;
            }else{
                result++;
            }
    ...
    private static boolean commandInput(String input, int result){
    ...
    private static boolean performMove(String input, int result){
